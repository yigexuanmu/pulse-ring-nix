...
fn zh<'a>(k: &'a str) -> Option<&'a str> {
    let table: &[(&str, &str)] = &[
        ...
        ("tab.widgets", "挂件"),
        ("tab.lyric", "歌词可视化"),
        // folia lyric visualizer
        ("folia.section.general", "总览"),
        ("folia.section.tuning", "当前模式参数"),
        ("folia.enabled", "启用歌词可视化"),
        ("folia.mode", "可视化模式"),
        ("folia.mode.classic", "流光"),
        ("folia.mode.cadenza", "Cadenza"),
        ("folia.mode.cadenza.note", "folia 上游未暴露 Cadenza 参数面板"),
        ("folia.mode.partita", "云阶"),
        ("folia.mode.fume", "浮名"),
        ("folia.mode.claddagh", "回环"),
        ("folia.mode.cappella", "群唱"),
        ("folia.mode.tilt", "倾诉"),
        ("folia.mode.pendolo", "时计"),
        ("folia.mode.monet", "莫奈"),
        ("folia.mode.diorama", "镜台"),
        ("folia.mode.sonnet", "商籁"),
        // shape
        ("shape.shape", "形状"),
        ("shape.ring", "环"),
        ("shape.square", "方"),
...
fn en<'a>(k: &'a str) -> Option<&'a str> {
    let table: &[(&str, &str)] = &[
        ...
        // folia lyric visualizer
        ("folia.section.general", "Overview"),
        ("folia.section.tuning", "Current mode tuning"),
        ("folia.enabled", "Enable lyric visualization"),
        ("folia.mode", "Visualizer mode"),
        ("folia.mode.classic", "Classic"),
        ("folia.mode.cadenza", "Cadenza"),
        ("folia.mode.cadenza.note", "folia exposes no Cadenza tuning UI"),
        ("folia.mode.partita", "Partita"),
        ("folia.mode.fume", "Fume"),
        ("folia.mode.claddagh", "Claddagh"),
        ("folia.mode.cappella", "Cappella"),
        ("folia.mode.tilt", "Tilt"),
        ("folia.mode.pendolo", "Pendolo"),
        ("folia.mode.monet", "Monet"),
        ("folia.mode.diorama", "Diorama"),
        ("folia.mode.sonnet", "Sonnet"),
        ("shape.shape", "Shape"),
        ("shape.ring", "Ring"),
        ("shape.square", "Square"),
